...
$query = "select * from userlocation where userid='{$_SESSION['userId']}' order by strdate";
$result = mysqli_query($link, $query);
$size=0;
                                            ...
                                            for($count=0;$count<$size;$count++)
                                            {
                                                if($intripline[$count]){
                                                    echo "<div class='task-title'>
                                                      ...
                                                      <a href='edittriptime.php?name=$locationName[$count]&object=start&id=$locationId[$count]'>开始日期：$strdate[$count]</a><a href='edittriptime.php?name=$locationName[$count]&object=end&id=$locationId[$count]'>结束日期：$enddate[$count]</a>
                                                      <button class='btn-clear-g' name='delete' onclick='window.location.href=\" ../personality/deletetripline.php?locationId= $locationId[$count]\"'>从行程中删去此景点</button>
                                                      </div>
                                                      </div>";
                                                }
...
//                                            <a href='../locationpage/location.php?locationId=$locationid[$count]'><img src='$locationimage[$count]' height='50' alt=''></a>
//                                            <span class='task-title-sp'>".$locationname[$count]."</span>
//                                            <div class='pull-right hidden-phone'>
//                                                <a href='edittriptime.php?name=$locationname[$count]&object=start&id=$locationid[$count]'>开始日期：$arraysta[$count]</a><a href='edittriptime.php?name=$locationname[$count]&object=end&id=$locationid[$count]'>结束日期：$arrayend[$count]</a>
//                                                <button class='btn-clear-g' name='delete' onclick='window.location.href=\"../personality/deletetripline.php?locationid=$locationid[$count]\"'>从行程中删去此景点</button>
//                                            </div>
//                                        </div>
//
//                                        ";
                            ...
                            <div class=" add-task-row">
                                ...
                                ?>location='tripline.php'">查看我的景点</button>
                                <button class="btn btn-default btn-sm pull-right" onclick="window.location.href='deletetripline.php?locationid=all'">删除所有景点</button>
                            </div>
                        </div>
                    </section>
                </div><!-- /col-md-12-->
