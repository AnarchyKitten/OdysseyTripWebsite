...
$sql="INSERT INTO locationcomment (userId,commentContent,commentDate,locationId) VALUES ('".$_SESSION['userId']."','".$comment."','".date('Y-m-d H:i:s',time()+3600*8)."','".$locationId."')";
//echo $sql;
...
//跳转
header("Location:location.php?locationId=$locationId");
exit;
