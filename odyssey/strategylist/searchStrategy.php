...
if($_GET["keywords"]) {
    ...
    while ($row = mysqli_fetch_array($sqlListResult))
    {
        echo "<div class=\"fh5co-entry padding\">
                ...
                <div>
                    <span class=\"fh5co-post-date\">".$row["strategyDate"]."</span>
                    <h2><a href=../strategypage/strategy.php?strategyId=".$row["strategyId"].">".mb_substr($row["strategyTitle"],0,23)."</a></h2>
                    <p>".mb_substr(strip_tags($row["strategyContent"]),0,30,'UTF-8')."..."."</p>
                </div>
            </div>";
    }}
?>
        ...
        <footer>
            <div>
                &copy; 2017 odyssey <a href="../home/home.html" target="_blank" > - welcome to odyssey</a>
            </div>
        </footer>
    </div>
</div>
