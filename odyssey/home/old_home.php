        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="home.php" title="HOME"><em class="ion-paper-airplane"></em><strong> Odyssey &nbsp; </strong><span><strong>爱达晒</strong></span></a></div>
                <!-- /.navbar-header -->
                ...
                <h3>欢迎来到 <bold>Odyssey
                    ...
                    <div>
                        <form  role="form" id="mc-form" action = "homeSearch.php" onsubmit="" method = "get" content="text/html; charset=utf-8">
                            <h3>
                                <input type="text" class="form-control" name="keywords" id="keywords" placeholder="请输入关键字" value=""/>
